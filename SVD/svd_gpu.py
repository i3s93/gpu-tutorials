"""
This script tests a GPU SVD using CuPy.
"""
...
parser = argparse.ArgumentParser(description="Computes the SVD of a matrix on the GPU.")
...
def main():
	...
	print(benchmark(cp.linalg.svd, (A,),  n_repeat=reps))
